Chain123 Core version *0.15.1* is now available from:

  <https://download.chain123.org/chain123-0.15.1/>
...
A number of changes to the way Chain123 Core deals with peer connections and invalid blocks
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 lc123 per kB (0.00001 C123). This is to prepare for dropping the minimum transaction fee to 0.1 lc123 per kB (0.0001 C123) in the next release.
