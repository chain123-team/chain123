Chain123 Core version 0.13.3 is now available from:

  <https://download.chain123.org/chain123-0.13.3/>
...
Developers who require the new testnet blockchain paramaters can find them [here](https://github.com/chain123-project/chain123/blob/0.13/src/chainparams.cpp#L214).
