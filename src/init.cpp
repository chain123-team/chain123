...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/chain123-project/chain123>";
    const std::string URL_WEBSITE = "<https://chain123.org>";
