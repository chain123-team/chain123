...
const char * const BITCOIN_CONF_FILENAME = "chain123.conf";
const char * const BITCOIN_PID_FILENAME = "chain123.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Chain123";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Chain123";
#else
    // Unix
    return pathRet / ".chain123";
#endif
#endif
}
