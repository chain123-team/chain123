...
#if defined(NDEBUG)
# error "Chain123 cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Chain123 Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s C123 additional fees, %d delta bytes\n",
