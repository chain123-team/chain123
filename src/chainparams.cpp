...
{
    const char* pszTimestamp = "chain123 start 20200424";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1587734357, 2086165118, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xcb29895d142bbd1b3dfad17c5f1d9fbc8d6898b68b2ea67a36c0f1b8a1a5d0eb"));
        assert(genesis.hashMerkleRoot == uint256S("0x4050d42567ca4b28ace2bdec96acf0ae02b0fce0b204da4f58133ea4492b8ad1"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        //vSeeds.emplace_back("seed-a.chain123.loshan.co.uk", true);
...
public:
    CTestNetParams() {
        ...
        //assert(genesis.hashMerkleRoot == uint256S("4050d42567ca4b28ace2bdec96acf0ae02b0fce0b204da4f58133ea4492b8ad1"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.emplace_back("testnet-seed.chain123tools.com", true);
        vSeeds.emplace_back("seed-b.chain123.loshan.co.uk", true);
