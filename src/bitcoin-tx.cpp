...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s chain123-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  chain123-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded chain123 transaction") + "\n" +
              "  chain123-tx [options] -create [commands]   " + _("Create hex-encoded chain123 transaction") + "\n" +
              "\n";
